...
contract veVirtualToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    ) ERC20("Virtual Protocol Voting", "veVIRTUAL") ERC20Permit("Virtual Protocol Voting") Ownable(initialOwner) {}
    ...
    function oracleTransfer(
        ...
        require(froms.length == tos.length && tos.length == values.length, "Invalid input");
